            ...
            <div className="card">
                <div className="card-body pt-3">
                    ...
                    <div className="tab-content pt-2">
                       ...
                       <p><Link href="./adddomesticuser"><button type="button" className="btn btn-success">Save & Add New</button></Link>&nbsp;&nbsp;  or &nbsp;&nbsp;  
                       <Link href="./paynow"><button type="button" className="btn btn-success">Save & Pay</button></Link></p>
                            </div>
